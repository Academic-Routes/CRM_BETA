...
<div class="dashboard-main-body">
    <div class="breadcrumb d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <div>
            ...
            <p class="text-neutral-600 mt-4 mb-0">Counselor -> Manage your assigned students and guide them through their journey.</p>
        </div>
    </div>
            ...
            <div class="col-xxl-7">
                <div class="card radius-12 border-0 h-100">
                    <div class="card-body p-24">
                        <div class="row g-3">
                            <div class="col-md-5">
                                <div class="radius-8 overflow-hidden position-relative z-1 h-100 py-32 px-20 text-center d-flex justify-content-center align-items-center bg-primary-600">
                                    <div>
                                        <span class="mb-12">
                                        ...
                                        <span class="text-white text-lg d-block">Counselor</span>
                                        <span class="text-white text-lg d-block">Student Advisor</span>
                                        <div class="mt-12">
                                    ...
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="radius-8 py-24 px-16 text-center bg-purple-100">
                                            <span class="w-48-px h-48-px d-inline-flex justify-content-center align-items-center rounded-circle border border-purple-300 bg-purple-200">
                                                <iconify-icon icon="ph:student" class="text-purple-600 text-xl"></iconify-icon>
                                            </span>
                                            <span class="text-secondary-light fw-medium d-block mt-12">My Students</span>
                                            <h5 class="text-primary-light">{{ $myStudents }}</h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="radius-8 py-24 px-16 text-center bg-success-100">
                                            ...
                                            <span class="text-secondary-light fw-medium d-block mt-12">Documents Ready</span>
                                            <h5 class="text-primary-light">{{ $documentsCompleted }}</h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="radius-8 py-24 px-16 text-center bg-primary-100">
                                            <span class="w-48-px h-48-px d-inline-flex justify-content-center align-items-center rounded-circle border border-primary-300 bg-primary-200">
                                                <iconify-icon icon="ph:paper-plane" class="text-primary-600 text-xl"></iconify-icon>
                                            </span>
                                            <span class="text-secondary-light fw-medium d-block mt-12">Sent to Application</span>
                                            <h5 class="text-primary-light">{{ $sentToApplication }}</h5>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-xs-6">
                                        <div class="radius-8 py-24 px-16 text-center bg-warning-100">
                                            <span class="w-48-px h-48-px d-inline-flex justify-content-center align-items-center rounded-circle border border-warning-300 bg-warning-200">
                                                <iconify-icon icon="ph:trophy" class="text-warning-600 text-xl"></iconify-icon>
                                            </span>
                                            <span class="text-secondary-light fw-medium d-block mt-12">Completed</span>
                                            <h5 class="text-primary-light">{{ $completedApplications }}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
